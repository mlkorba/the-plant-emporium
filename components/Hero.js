  ...
  return (
    ...
    >
      ...
      <div className="hero-content text-center relative z-10 px-5 sml:px-6 md:px-8">
        ...
        <Link href="/products" className="cta-button bg-jungleGreen text-white py-2 px-4 rounded-full inline-block text-lg drop-shadow-md hover:bg-oliveGreen duration-300 cursor-pointer">Explore Our Collection</Link>
      </div>
    </div>
  )
}