  ...
  return (
    ...
    >
      ...
      <div className="hero-content text-center relative z-10 ">
        ...
        <a href="#" className="cta-button bg-jungleGreen text-white py-2 px-4 rounded inline-block text-lg hover:bg-oliveGreen duration-300 cursor-pointer">Explore Our Collection</a>
      </div>
    </div>
  )
}
